...
<body>
    ...
    <div style="padding: 60px 140px;" class="container-fluid">
        <div id="wrapper">
            <form action="xulysignup.php" id="form-login" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="dia_chi" placeholder="Địa chỉ" required>
                </div>
                <div class="form-group">
                    <i class="fas fa-phone"></i>
                    <input type="text" class="form-input" name="so_dien_thoai" placeholder="Số điện thoại" required>
                </div>
                <div class="form-group">
